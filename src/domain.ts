...
export interface AtlasEdge { id:string; source:string; target:string; label:string; description:string; protocol:string; port:string; authentication:string; encryption:string; dataClassification:string; notes:string }
